...
(function ($) {
    ...
    $.addFlex = function (t, p) {
        ...
        var g = {
            ...
            download: function () {
                ...
                window.location.href = "/tables/" + table_id + "/download?" + $.param(param);
            },
            ...
            if (p.searchitems) {
                ...
                */
                ...
                if (false) {
                    ...
                    allDownloadDiv.innerHTML = "<div><span>All</span></div>";
    ...
    $.fn.flexigrid = function (p) {
        if (toString.call(p["onSuccess"]).slice(8, -1).toLowerCase() === "string") {
            p["onSuccess"] = new Function(p["onSuccess"]);
        }
        for (let i = 0; i < p["buttons"].length; i++) {
            if (toString.call(p["buttons"][i]["onpress"]).slice(8, -1).toLowerCase() === "string") {
                p["buttons"][i]["onpress"] = new Function(p["buttons"][i]["onpress"]);
            }
        }
